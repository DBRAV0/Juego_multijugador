//Aquí sería la connexion a la base de datos para extraer el highscore
//const connection = require("./conexion")
//import { sumar } from "./variable.js";
...
var GM = {
  ...
  ScoreHigh: hi, ScoreCur:0, ScoreBonus:0, DifficultFlag: 0,
  ...
  GameOver: function(){
    ...
    // window.parent.postMessage(this.ScoreCur, '*');
    this.IsAlive = false; 
  }
